    ...
    <div class="card">
		...
		<table class="table datatable-responsive-column-controlled">
			...
			<tbody>
                ...
                <tr>
					<th></th>
					<th>{{isset($v->bidang) ? $v->bidang->nama:'-'}}</th>
						...
						<div class="list-icons">
							<div class="dropdown">
								...
								<div class="dropdown-menu dropdown-menu-right">
									<a href="{{ route('backend.jenis.edit',[$v->id]) }}" class="dropdown-item"><i class="icon-pencil"></i> Edit</a>
									<a href="{{ route('backend.jenis.destroy',[$v->id]) }}" class="dropdown-item"><i class="icon-trash"></i> Hapus</a>
								</div>
							</div>
						</div>
					</th>
...
@endsection                
@section('title')
<h4><span class="font-weight-semibold">Data</span> Jenis</h4>
@endsection
@section('breadcrumb')
...
<span class="breadcrumb-item active">Data Jenis</span>
@endsection
